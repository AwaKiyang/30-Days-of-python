...
#sort countries by nme by capital and population
dic = list(map(lambda data: {'names' : data['name'], 'capital' : data['capital'], 'population' : data['population']},countries))
print(dic)
...
def ten_most():
    ...
    return final[0:10] #slice to return 10 most spoken language
print(ten_most())

#sort out the ten most populated countries
def ten_pop():
    pop = list(map(lambda pay: {'country' : pay['name'], 'population' : pay['population']},countries)) #mapping the population into pop array
    pop.sort(key=lambda x : x['population'],reverse=True) #sorting 
    return pop[0:10] #slicing
print(ten_pop())